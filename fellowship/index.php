...
$CURRENTDIRURL = $ROOTURL . "fellowship/";
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $CURRENTDIRURL ?>css/style.css">
    </link>
        ...
        <div class="main">
            <div class="contentContainer">
                <ul class="annexureContainer largeContentCard">
                    ...
                    <li>
                        <a href="<?php echo $CURRENTDIRURL ?>fellowship/assets/ANNEXURE_G.pdf" target="_blank">
                            Annexure G
                            <img src="<?php echo $ROOTURL ?>/public/assets/download_icon.svg">
                        </a>
                    </li>
