...
<body>
    ...
    <div class="marquee">
        <div class="marqueeContent">
            ...
            <a href="<?php echo $ROOTURL ?>/procurement-cell/assets/2025-26/NOTICE FOR E-TENDER.pdf" target="_blank" style="position: relative;"><span style="position: absolute; color: green; top: 0; left: 0; transform: translate(-30%); animation: blink 1s steps(2, start) infinite; text-shadow: none">New</span>E-Tender regarding purchase of Dental Equipment & Dental Materials as well as Consumables</a>
             <a href="<?php echo $ROOTURL ?>/procurement-cell/assets/2025-26/Tander for Mess and Canteen.pdf" target="_blank" style="position: relative;"><span style="position: absolute; color:green; top: 0; left: 0; transform: translate(-30%); animation: blink 1s steps(2, start) infinite; text-shadow: none">New</span>Tender for Hostel Mess and Canteen on Contract Basis</a>
			<a href="<?php echo $ROOTURL ?>/procurement-cell/assets/2025-26/रुग्णालयीन कपडे धुलाईसाठी सेवा पुरवठादार नेमणेकामी दरपत्रक मागणीपत्र.pdf" target="_blank" style="position: relative;"><span style="position: absolute; top: 0; left: 0; transform: translate(-30%); animation: blink 1s steps(2, start) infinite; text-shadow: none; color: green;">New</span>रुग्णालयीन कपडे धुलाईसाठी सेवा पुरवठादार नेमणेकामी दरपत्रक मागणीपत्र</a> 
